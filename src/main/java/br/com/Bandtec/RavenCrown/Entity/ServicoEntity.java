...
public class ServicoEntity {
    ...
    public ServicoEntity(int id_Servico, UsuarioEntity prestador, EnderecoEntity endereco, List<ComentarioEntity> comentarios, List<DataServicoEntity> datas, CategoriaEntity categoria, String nome_Servico, String descricao_Servico, LocalTime tempo_Execucao, Double preco_Servico, boolean localizacao_Fixa) {
