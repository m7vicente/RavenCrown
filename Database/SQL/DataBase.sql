...
ALTER TABLE TBD_ENDERECO ADD ID_USUARIO INT FOREIGN KEY REFERENCES TBD_USUARIO(ID_USUARIO)
...
CREATE TABLE TBD_SERVICO (
    ...
    ID_CATEGORIA INT FOREIGN KEY REFERENCES TBI_CATEGORIA(ID_CATEGORIA)
);
...
CREATE TABLE TBD_DEMANDA (
    ...
    ID_ENDERECO INT NULL FOREIGN KEY REFERENCES TBD_ENDERECO (ID_ENDERECO),
...
CREATE TABLE TBD_DATAS_SERVICO_AGENDADO(
    ID_DATA_AGENDADO INT PRIMARY KEY IDENTITY,
    ID_USUARIO_PRESTADOR INT FOREIGN KEY REFERENCES TBD_USUARIO (ID_USUARIO),
    ID_USUARIO_CONSUMIDOR INT FOREIGN KEY REFERENCES TBD_USUARIO (ID_USUARIO),
    ID_SERVICO INT FOREIGN KEY REFERENCES TBD_SERVICO (ID_SERVICO),
...
CREATE TABLE TBD_RECOMENDACAO(
	ID_RECOMENDACAO INT PRIMARY KEY IDENTITY,
	NOME_FUNCAO VARCHAR(200) NOT NULL,
	QUANTO_TEMPO DATE,
	DESCRICAO VARCHAR(200),
	NOME_RECOMENDACAO VARCHAR(200),
	TELEFONE VARCHAR(20),
	ID_USUARIO INT FOREIGN KEY REFERENCES TBD_USUARIO(Id_usuario)
);

SELECT * FROM TBD_ENDERECO
SELECT * FROM TBD_USUARIO
SELECT * FROM  TBI_IMAGEM_USUARIO 
SELECT * FROM TBD_SERVICO
SELECT * FROM TBD_DATAS_SERVICO_AGENDADO;
SELECT * FROM TBI_IMAGEM_SERVICO
SELECT * FROM TBD_COMENTARIO
SELECT * FROM TBI_CATEGORIA
SELECT * FROM TBD_CONTRATO
SELECT * FROM TBD_DEMANDA